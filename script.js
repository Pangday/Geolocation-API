...
// const neighbour = data.borders?.[0]; // instead of:
// const [neighbour] = data.borders;
...
const whereAmI = async function () {
  try {
    ...
    // Reverse geocoding
    const resGeo =
      await fetch(`https://api.bigdatacloud.net/data/reverse-geocode-client?latitude=${lat}&longitude=${lng}&localityLanguage=en
 `);
...
/*
//////////////////////////////////////////////////////////////////////////////////////
// LECTURE 266. Other Promises Combinators: race, allSettled and any
